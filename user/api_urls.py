...
urlpatterns = [
    ...
    path('branch/change-password/', BranchChangePasswordView.as_view(), name='branch_change_password'),
    ...
    path('reports/admin/slot-bookings/<int:slot_id>/download/', AdminSlotBookingDetailView.as_view(), name='admin_slot_booking_detail'),
